...
// import { GithubOauthProvider } from "@clerk/types";
// import { LinkedinOauthProvider } from "@clerk/types";
...
//     });
//   };
//   const signInWithGithub = (strategy: GithubOauthProvider) => {
//     return signIn.authenticateWithRedirect({
//       GithubOauthProvider,
//       redirectUrl: "/sign-up/sso-callback",
//       redirectUrlComplete: "/",
//     });
//   };
//   const signInWithLinkedin = (strategy: LinkedinOauthProvider) => {
//     return signIn.authenticateWithRedirect({
//       strategy,
//       redirectUrl: "/sign-up/sso-callback",
//       redirectUrlComplete: "/",
...
//               <button
//                 type="button"
//                 onClick={() => signInWithGithub("oauth_github")}
//               >
//                 <FaGithub className="h-10 w-10" />
//               </button>
//               <button
//                 type="button"
//                 onClick={() => signInWithLinkedin("oauth_linkedin")}
//               >
...
const SignupForm = ({ signUpWithEmail, clerkError }: SignUpFormProps) => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    // Call the signUpWithEmail function with the form data
    await signUpWithEmail({ emailAddress: email, password });
    setLoading(false);
  };
