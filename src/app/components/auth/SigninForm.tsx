...
const SigninForm = ({ signInWithEmail, clerkError }: SignInPageProps) => {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-black text-white px-12 overflow-hidden relative leftside">
      {/* Leftside content hidden on mobile */}
      ...
      {/* Right side content */}
      <div className="relative w-full md:w-[30%] h-auto rightside mx-auto">
